...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/anoop/Work/udacity/robotics_sw_engineer/p2/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/anoop/Work/udacity/robotics_sw_engineer/p2/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/anoop/Work/udacity/robotics_sw_engineer/p2/install)
...
if(NOT "/home/anoop/Work/udacity/robotics_sw_engineer/p2/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/anoop/Work/udacity/robotics_sw_engineer/p2/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'anoop <anoop@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anoop/Work/udacity/robotics_sw_engineer/p2/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/anoop/Work/udacity/robotics_sw_engineer/p2/devel/lib;/home/anoop/Work/udacity/robotics_sw_engineer/p2/devel/lib;/home/anoop/Work/udacity/robotics_sw_engineer/simple_mover/catkin_ws/devel/lib;/opt/ros/melodic/lib)
